...
(function () {
  ...
  console.log('%cSites shipped. Events tracked. Opt-out remembered.', 'color: #8b909a');
  console.log('%cHints: triple-click logo · Konami · type datacenter, tracking, or mojave', 'color: #8b909a');
